...
data class GenericCandidates(val default: Expr<BoolType>, val candidateMap: Map<Invariant, Expr<BoolType>>) : InvariantCandidates {
    override fun get(invariant: Invariant): Expr<BoolType> = candidateMap[invariant] ?: default
}

data class CNFCandidates(val default: List<AndExpr>, val candidateMap: Map<Invariant, List<AndExpr>>) : InvariantCandidates {
